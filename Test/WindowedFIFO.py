...
class WindowedFIFO(object):
    ...
    def write(self, data, nSamples):
        self.lib.WFIFOB_write(self.obj, np.ascontiguousarray(data, dtype=np.float32), nSamples)
    ...
    def _decorateFunctions(self):
        ...
        self._setTypes(self.lib.WFIFOB_write, None, [ctypes.c_void_p, _c_ndfloat, ctypes.c_int32])
